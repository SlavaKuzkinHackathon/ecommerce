...
let AuthService = class AuthService {
    ...
    async registration(userDto) {
        const canditate = await this.usersService.getUsersByEmail(userDto.email);
        if (canditate) {
            throw new common_1.HttpException('Пользователь с таким Email сущуствует', common_1.HttpStatus.BAD_REQUEST);
        }
